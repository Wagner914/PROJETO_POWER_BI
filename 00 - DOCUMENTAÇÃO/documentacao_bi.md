...
Os dados são extraídos dos seguintes arquivos, gerados por um script Python nos formatos de csv, xlsx e parquet para que o usuário possa escolher qual o melhor modelo para trabalhar:
